...
ActiveRecord::Schema.define(version: 20160515193207) do
  ...
  add_index "photos", ["place_id", "caption", "picture"], name: "index_photos_on_place_id_and_caption_and_picture", using: :btree
